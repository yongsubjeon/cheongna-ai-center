...
export default function ComputerScienceCoursePage() {
  ...
  const handleTimestampClick3 = (seconds: number) => {
    if (iframeRef3.current && iframeRef3.current.contentWindow) {
      iframeRef3.current.contentWindow.postMessage(`{"event":"command","func":"seekTo","args":[${seconds}, true]}`, "*")
    }
  }

  const handleTimestampClick4 = (seconds: number) => {
    if (iframeRef4.current && iframeRef4.current.contentWindow) {
      iframeRef4.current.contentWindow.postMessage(`{"event":"command","func":"seekTo","args":[${seconds}, true]}`, "*")
    }
  }
      ...
      <div className="bg-gradient-to-r from-green-600 to-teal-600 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <Badge className="bg-white text-green-600 mb-4">이미지 영상 AI로 만들기</Badge>
            <h1 className="text-4xl font-bold mb-4">생성형 AI 이미지 영상 만들기</h1>
            <p className="text-lg mb-6 opacity-90">생성형 이미지 아주 쉽게 시작하기</p>
              ...
              <div className="mb-12">
                ...
                <div className="space-y-4">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold text-lg">
                          섹션 1. AI 영상 영화 제작 입문자를 위한 시간 아끼는 편집 비법 공개
                        </h3>
                      ...
                      <div className="mb-4">
                        <div className="aspect-video w-full">
                          <iframe
                            ...
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/8P6Q_RnlvJo?enablejsapi=1"
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold text-lg">섹션 2. 15분만에 만드는 애니메이션 영상</h3>
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          <span>5분</span>
                        </div>
                      </div>
                      ...
                      <div className="mb-4">
                        <div className="aspect-video w-full">
                          <iframe
                            ...
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/vWycO5TfawY?enablejsapi=1"
                            title="YouTube video player"
                            frameBorder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowFullScreen
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick2(33)}
                          >
                            00:33 15분만에 만든 애니메이션 숏츠 영상
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick2(64)}
                          >
                            01:04 짧은 텍스트 문장가지고 만들수있는 필모라
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick2(92)}
                          >
                            01:32 첫번째 단계: 스토리 만들기 Chat gpt
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick2(126)}
                          >
                            02:06 두번째 단계: AI 아이디어를 동영상으로 변환 필모라
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick2(200)}
                          >
                            03:20 캐릭터 생성할 때 주의할점
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick2(239)}
                          >
                            03:59 세번째 단계: 간단 편집작업 필모라
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick2(259)}
                          >
                            04:19 숏츠 영상 활용
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick2(283)}
                          >
                            04:43 내용 요약
                          </span>
                        </div>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold text-lg">섹션 3. 동일한 캐릭터로 연속 이미지 만들기</h3>
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          <span>6분</span>
                        </div>
                      </div>
                      ...
                      <div className="mb-4">
                        <div className="aspect-video w-full">
                          <iframe
                            ...
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/-vAmrsYw2VI?enablejsapi=1"
                            title="YouTube video player"
                            frameBorder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowFullScreen
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(0)}
                          >
                            00:00 동일한 캐릭터 이걸로 만든다!
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(20)}
                          >
                            00:20 Dzine AI 기능들ㅣ 드진 or 드자인
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(39)}
                          >
                            00:39 동일한 캐릭터 만드는 법
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(169)}
                          >
                            02:49 동일한 캐릭터 연동 이미지 만들기
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(218)}
                          >
                            03:38 등장인물 원하는 캐릭터로 바꾸기
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(242)}
                          >
                            04:02 Dzine AI 구독료
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(266)}
                          >
                            04:26 이미지로 애니메이션 영상 만들기
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(333)}
                          >
                            05:33 드진/드자인으로 이렇게 편하게!
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(339)}
                          >
                            05:39 협업으로 10% 할인 받는 법
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick3(353)}
                          >
                            05:53 진행한 샘플 진행과정 공유
                          </span>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold text-lg">섹션 4. AI 영상 제작 고급 기법</h3>
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          <span>8분</span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(0)}
                          >
                            00:00 고급 AI 영상 제작 시작하기
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          <Play className="w-4 h-4 text-gray-400" />
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(45)}
                          >
                            00:45 프로페셔널 편집 기법
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(120)}
                          >
                            02:00 색상 보정과 필터 적용
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(180)}
                          >
                            03:00 음향 효과 추가하기
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(240)}
                          >
                            04:00 트랜지션 효과 활용
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(300)}
                          >
                            05:00 텍스트 애니메이션 만들기
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(360)}
                          >
                            06:00 최종 렌더링 설정
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(420)}
                          >
                            07:00 품질 최적화 팁
                          </span>
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                          ...
                          <span
                            className="cursor-pointer hover:text-green-600 transition-colors"
                            onClick={() => handleTimestampClick4(480)}
                          >
                            08:00 마무리 및 정리
                          </span>
                        </div>
